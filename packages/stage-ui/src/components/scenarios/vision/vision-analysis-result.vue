...
<template>
  <div class="vision-analysis-result">
    <div class="result-header">
      <span class="title">{{ t('tamagotchi.stage.vision.screen-analysis') }}</span>
      <button
        class="close-btn"
        @click="emit('close')"
      >
    ...
    <div v-if="isAnalyzing" class="analyzing">
      {{ t('tamagotchi.stage.vision.analyzing') }}
    </div>
    ...
    >
      ...
      >
        <div class="section-title">
          {{ t('tamagotchi.stage.vision.ui-elements') }}
        </div>
        <div
      ...
      >
        <div class="section-title">
          {{ t('tamagotchi.stage.vision.suggestions') }}
        </div>
        <button
    ...
    <div v-else class="no-result">
      {{ t('tamagotchi.stage.vision.no-analysis') }}
    </div>
  </div>
</template>
